...
export const FAQ_ITEMS: FaqItem[] = [
  ...
  { q: "Where can I buy heavy-duty truck parts online?", a: "At PartsNow.ai: 16,000+ new and OEM parts from trusted dealers, shipped nationwide from Knoxville, TN, with free local pickup. Mike can order it for you right from the chat." },
